...
# General
model_name_dir="led-base-16384" # led-base-16384 led-large-16384
run_dir="mimic-iv-note-di-bhc_led-base-16384_4000_600_chars_100_valid" # 4000_600_chars_100_valid long_data_100_valid
...
# Parameters
for dropout in 0.05; do #0.1 0.2; do  # 0.05 0.1 0.2
    for learning_rate in "5e-4"; do # "1e-5" "5e-5" "1e-6" "5e-6"; do  # "5e-4" "1e-5" "5e-5" "1e-6" "5e-6"
        # Define run folder
        # folder_name="debug"
        ...
        experiment_path="${output_path}/${folder_name}"
            ...
            # Local
            bash ${code}/scripts/sm_parameter_tuning_led.sh ${experiment_path} ${dropout} ${learning_rate}
        #else
