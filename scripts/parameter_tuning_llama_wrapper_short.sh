...
# General
model_name_dir="Llama-2-7b-hf" # Llama-2-7b-hf Llama-7-70b-hf
run_dir="mimic-iv-note-di-bhc_Llama-2-7b-hf_4000_600_chars_100_valid" # 4000_600_chars_100_valid long_data_100_valid

# Cluster
#project="/home/s/s_hegs02/scratch/mimic-iv-note-di-bhc"
#code="/home/s/s_hegs02/patient_summaries_with_llms"

# setting for google drive location in colab
project="/content/drive/MyDrive/DL4H-Project/mimic-iv-note-di-bhc"
code="/content/drive/MyDrive/DL4H-Project/patient_summaries_with_llms"
...
# Parameters
for lora_rank in 8;  do  # 8 32, if possible might also check 4, 16
    for lora_alpha in 32; do  # 8 32
        for lora_dropout in 0.1; do # 0.05 0.1
            for num_target_modules in 2; do # 2 4
                for learning_rate in "2e-5"; do # First round only "2e-5" "2e-4", full: "5e-6" "2e-5" "5e-4" "2e-4" "5e-5"
                    # Define run folder
                    # folder_name="debug"
