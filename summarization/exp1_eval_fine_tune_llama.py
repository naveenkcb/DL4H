...
from transformers import (
    ...
    BitsAndBytesConfig,
    Trainer, 
    TrainingArguments  # <-- ADD this explicitly nc42
)
...
def main():
    ...
    def predict(prediction_model, dataset):
        ...
        for ex in dataset:
            ...
            input_tokens = tokenizer(input_prompt, return_tensors="pt")["input_ids"].to(device) #nc42
    ...
    if args.evaluation:
        ...
        trained_model = PeftModel.from_pretrained(model, args.evaluation_model_path, torch_dtype=torch.float16).to(device) #nc42
        #trained_model = PeftModel.from_pretrained(model, args.evaluation_model_path, torch_dtype=torch.float16)
        ...
        training_args = TrainingArguments(
                    ...
                    #evaluation_strategy="steps",  nc42
                    eval_strategy="steps",
        ...
        # Training
        # nc42 modified the below method
        '''
        ...
        trainer = SFTTrainer(
            ...
            #nc42 formatting_func will handle this
            #tokenizer=tokenizer,  
            #nc42 data_collator will handle this
